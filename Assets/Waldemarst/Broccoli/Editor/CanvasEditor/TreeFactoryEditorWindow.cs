	...
	public class TreeFactoryEditorWindow : EditorWindow 
	{
		...
		*/
		...
		private void DrawSidePanel ()
		{
			...
			DrawSproutGroupList ();
			EditorGUILayout.Space ();
			if (GlobalSettings.experimentalSproutLabEnabled) {
				DrawBranchDescriptorList ();
				EditorGUILayout.Space ();
			}
			DrawDebugOptions ();
			EditorGUILayout.Space ();
		...
		/// <summary>
		/// Draws the branch descriptor list.
		/// </summary>
		private void DrawBranchDescriptorList () {
		...
		private void DrawPrefabOptions () {
			...
			EditorGUILayout.LabelField ("Clone assigned custom materials inside prefab.", BroccoEditorGUI.label);
			EditorGUILayout.EndHorizontal ();
