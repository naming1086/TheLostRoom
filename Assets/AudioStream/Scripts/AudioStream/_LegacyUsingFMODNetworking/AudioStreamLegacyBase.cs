    ...
    public abstract class AudioStreamLegacyBase : MonoBehaviour
    {
        ...
        IEnumerator StreamCR()
        {
            ...
            for (; ; )
            {
                ...
                {
                    LOG(LogLevel.INFO, "Starving frame: {0} / {1}", this.starvingFrames, this.starvingRetryCount_FileStopped.HasValue ? this.starvingRetryCount_FileStopped.Value : this.starvingRetryCount);
