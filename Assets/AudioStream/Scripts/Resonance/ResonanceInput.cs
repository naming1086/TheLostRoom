...
namespace AudioStream
{
    ...
    public class ResonanceInput : AudioStreamInputBase
    {
        ...
        protected override void RecordingStarted()
        {
             ...
             */
            this.resonancePlugin = new ResonancePlugin(this.recording_system.system, this.logLevel);
            ...
            result = this.recording_system.system.playSound(sound, master, false, out channel);
            ...
            /*
             * debug info about playing channel
             */
            int channels, realchannels;
            result = this.recording_system.system.getChannelsPlaying(out channels, out realchannels);
            ERRCHECK(result, "this.recording_system.system.getChannelsPlaying", false);
